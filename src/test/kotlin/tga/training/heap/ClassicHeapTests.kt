...
class ClassicHeapTests {

    @Test fun `basic operations min heap`() {
        val heap = ClassicHeap<Int>()
        ...
        assertThat(heap.remove()).isEqualTo(10); assertThat(heap.size).isEqualTo(6)
        assertThat(heap.remove()).isEqualTo(15); assertThat(heap.size).isEqualTo(5)
        assertThat(heap.remove()).isEqualTo(20); assertThat(heap.size).isEqualTo(4)
        assertThat(heap.remove()).isEqualTo(30); assertThat(heap.size).isEqualTo(3)
        assertThat(heap.remove()).isEqualTo(50); assertThat(heap.size).isEqualTo(2)
        assertThat(heap.remove()).isEqualTo(70); assertThat(heap.size).isEqualTo(1)
        assertThat(heap.remove()).isEqualTo(90); assertThat(heap.size).isEqualTo(0)
